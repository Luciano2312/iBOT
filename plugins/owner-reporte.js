const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  conn.reply('5493886455711@s.whatsapp.net', m.quoted ? teks + m.quoted.text : teks, null, {contextInfo: {mentionedJid: [m.sender]}});
...
handler.tags = ['info'];
handler.command = /^(reporte|report|request|reporte|bugs|bug|report-owner|reportes)$/i;
